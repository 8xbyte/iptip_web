...
const faculties: Array<IFaculty> = [
    ...
    },
    {
        ...
        description:
            'В рамках профиля ведётся подготовка специалистов, которые умеют анализировать требования, предъявляемые к разрабатываемым бизнес-приложениям, дорабатывать типовые конфигурации и также проводить полный цикл разработки бизнес-приложений на основе платформы 1С:Предприятие. Выпускники способны разрабатывать платформенные бизнес-приложения для автоматизации задач организационного управления и бизнес-процессов',
        exams: [
            [
                {
                    name: 'Профильная математика',
    ...
    },
    {
        ...
        description:
            'В рамках профиля осуществляется подготовка специалистов, способных анализировать требования к разрабатываемым информационным системам, проектировать и оптимизировать их архитектуру, а также обеспечивать качество и производительность в условиях высокой нагрузки. Выпускники овладевают навыками разработки и сопровождения высоконагруженных бизнес- приложений, автоматизирующих задачи организационного управления и бизнес - процессов, с использованием современных технологий и платформ, в частности, 1С: Предприятие',
        exams: [
            [
                {
                    name: 'Высшая математика',
